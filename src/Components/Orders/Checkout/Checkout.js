...
class Checkout extends Component {
    ...
    goBack = () => {
        this.props.history.goBack("/"); //history router er property
    }
    ...
    submitHandler = () => {
        ...
        axios.post("https://burger-builder-3b272-default-rtdb.firebaseio.com/orders.json?auth=" + this.props.token, order) //firebase
            .then(response => {
